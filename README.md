...
# Python environment (portable)

Create and activate a Python environment with the runtime dependencies:
...
> CMake now detects Python, Python headers, and NumPy from the **active environment** automatically.
