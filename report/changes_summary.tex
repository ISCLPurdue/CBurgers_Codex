...
\begin{itemize}
  \item \textbf{Baseline stacked LSTM},
  \item \textbf{Stabilized delta-LSTM},
...
\bottomrule
\end{tabular}
\caption{Autoregressive deployment RMSE comparison across model generations.}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{Mean deployment RMSE across baseline, stabilized, and seq2seq model variants.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\linewidth]{../build/Model_Comparison_ByMode.png}
  \caption{Per-mode deployment RMSE across model generations.}
\end{figure}
